 ...
 */
const { wrapEmail, sectionHeading, detailsCard, ctaButton, greeting, note, formatDate, tokens, iconCalendar, iconMoon, iconCard, iconTip, iconClock, iconCheck } = require('./emailLayout');
...
function buildRemainingBalanceEmail({ guestName, checkInDate, checkOutDate, nights, totalPrice, depositAmount, remainingBalance, paymentUrl, locale = 'en' }) {
    ...
    const t = {
        ...
        es: {
            ...
            deadline: `${iconClock()} <strong>Aviso importante:</strong> Para mantener tu reserva activa, este pago debe completarse en un plazo de <strong>48 horas</strong>. Las reservas no pagadas se cancelarán automáticamente y el depósito se gestionará según nuestra política de cancelación.`,
    ...
    const content = [
        ...
        detailsCard({
            ...
            rows: [
                ...
                [l.depositPaid, `${iconCheck()} €${depositAmount}`, `color: ${tokens.success}; font-weight: 600;`],
